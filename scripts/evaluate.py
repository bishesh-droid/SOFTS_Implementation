...
if __name__ == "__main__":
    # Example usage:
    # To evaluate the latest saved model, find its path in the checkpoints/ directory
    # checkpoint = "checkpoints/best_model_epoch_X.pth"
    # evaluate_model(checkpoint_path=checkpoint)
    evaluate_model()
